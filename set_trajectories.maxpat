...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 523.0, 580.0, 29.5, 22.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 523.0, 494.5, 69.0, 51.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "trajectories", "controller" ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 682.0, 690.0, 150.0, 46.0 ],
					"text" : "/cursor : [0.72759, 0.229531, 0.240682]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 523.0, 644.0, 42.0, 22.0 ],
					"text" : "switch"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 198.0, 569.0, 201.0, 44.0 ],
					"text" : "/cursor = /source/1/xyz,\ndelete(/source/1/xyz)"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 118.0, 299.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 118.0, 272.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 753.0, 562.0, 84.0, 22.0 ],
					"text" : "o.pack /cursor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 846.5, 341.0, 211.0, 22.0 ],
					"text_width" : 121.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 846.5, 316.0, 211.0, 22.0 ],
					"text_width" : 121.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 846.5, 292.0, 211.0, 22.0 ],
					"text_width" : 121.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 846.5, 268.0, 211.0, 22.0 ],
					"text_width" : 121.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 846.5, 244.0, 211.0, 22.0 ],
					"text_width" : 121.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "float", "" ],
					"patching_rect" : [ 753.0, 383.0, 71.0, 22.0 ],
					"text" : "pipo biquad"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 847.5, 432.0, 209.0, 106.0 ],
					"setminmax" : [ -1.5, 1.5 ],
					"setstyle" : 1,
					"signed" : 1,
					"size" : 3
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.0, 248.0, 53.0, 22.0 ],
					"text" : "ml.scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 753.0, 208.0, 111.0, 22.0 ],
					"text" : "o.route /comp_filter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 753.0, 82.0, 213.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "FullPacket", "FullPacket" ],
					"patching_rect" : [ 753.0, 123.0, 385.0, 70.0 ],
					"text" : "/alpha = 0.98,\n/accel = /accel * 9.81,\n\n/comp_filter = /alpha * /gyro + (1 - /alpha) * /accel"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 118.0, 690.0, 281.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 330.0, 150.0, 75.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 485.0, 150.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 406.0, 150.0, 70.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 38.0, 183.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.0, 38.0, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 702.0, 135.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 127.5, 561.5, 207.5, 561.5 ],
					"order" : 0,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 856.0, 331.099996834993362, 762.5, 331.099996834993362 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-78", 0 ],
					"midpoints" : [ 856.0, 319.099996834993362, 762.5, 319.099996834993362 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-78", 0 ],
					"midpoints" : [ 856.0, 367.599996834993362, 762.5, 367.599996834993362 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-78", 0 ],
					"midpoints" : [ 856.0, 355.099996834993362, 762.5, 355.099996834993362 ],
					"source" : [ "obj-76", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-78", 0 ],
					"midpoints" : [ 856.0, 343.099996834993362, 762.5, 343.099996834993362 ],
					"source" : [ "obj-77", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 762.5, 418.0, 857.0, 418.0 ],
					"order" : 0,
					"source" : [ "obj-78", 0 ]
				}
